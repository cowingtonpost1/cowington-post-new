    ...
    return (
        <div>
            ...
            <p>
                ...
                materials on Cowington Post's Website for personal,
            ...
            <p>
                This will let Cowington Post to terminate upon violations of any
            ...
            <p>
                All the materials on Cowington Post’s Website are provided "as
                is". Cowington Post makes no warranties, may it be expressed or
                implied, therefore negates all other warranties. Furthermore,
                Cowington Post does not make any representations concerning the
            ...
            <p>
                Cowington Post or its suppliers will not be hold accountable for
                any damages that will arise with the use or inability to use the
                materials on Cowington Post’s Website, even if Cowington Post or
            ...
            <p>
                The materials appearing on Cowington Post’s Website may include
                technical, typographical, or photographic errors. Cowington Post
                will not promise that any of the materials in this Website are
                accurate, complete, or current. Cowington Post may change the
                materials contained on its Website at any time without notice.
                Cowington Post does not make any commitment to update the
                materials.
            </p>
            ...
            <p>
                Cowington Post has not reviewed all of the sites linked to its
                Website and is not responsible for the contents of any such
                linked site. The presence of any link does not imply endorsement
                by Cowington Post of the site. The use of any linked website is
            ...
            <p>
                Cowington Post may revise these Terms of Use for its Website at
            ...
            <p>
                Any claim related to Cowington Post's Website shall be governed
